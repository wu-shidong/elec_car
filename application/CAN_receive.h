...
typedef enum
{
    ...
    DM_YAW_MOTOR_ID = 0x05,
    DM_PIT_MOTOR_ID = 0x06,
} can_msg_id_e;
...
/**
 * @brief  这里对电机进行依次使能，在对电机进行控制前进行使能
 * @param  void     	
 * @param  vodi      
 * @param  void    	
 * @param  void      	
 ...
 * @param  _vel   速度给定
 */
extern void PosSpeed_CtrlMotor(CAN_HandleTypeDef*hcan, CANx_t *motor ,uint16_t id,float _pos,float _vel);
/**
